...
## Workflow 
### (If you have access to CUDA5, skip to compilation and execution program. The below preprocessing is done and saved in CUDA5 /scratch/pvg2018/ if you dont have access, email pvg2018@nyu.edu or ax2119@nyu.edu or sc10670@nyu.edu)
